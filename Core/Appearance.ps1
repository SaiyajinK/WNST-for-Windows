...
function Apply-Language {
    ...
    $AboutTitle.Text = T 'AboutTitle'; $AboutSubtitle.Text = ''; $AboutSubtitle.Visibility='Collapsed'; $AboutProductName.Text=T 'ProductName'; $AboutDescription.Text = T 'AboutDescription'; $AboutStarHint.Text=T 'AboutStarHint'; $AboutSupportTitle.Text=T 'SupportTitle'; $GitHubButtonText.Text = 'GitHub'; $RepositoryButtonText.Text='GitHub'; $KoFiButtonText.Text = 'Ko-fi'; $VersionText.Text = (TF 'Version' @('1.0.1')); $UpdateCheckTitle.Text = T 'UpdateCheckTitle'; if ([string]::IsNullOrWhiteSpace([string]$UpdateCheckStatus.Tag)) { $UpdateCheckStatus.Text = T 'UpdateCheckHint' }; $CheckUpdatesButton.Content = T 'CheckUpdates'; $UpdateResultAction.Content = T 'OpenRelease'; $UpdateResultClose.ToolTip = T 'Dismiss'
